...
const About = () => {
  const teamMembers = [
    {
      name: 'মুফতি আহমেদ হাসান',
      role: 'প্রধান মুফতি ও ইসলামিক গবেষক',
      bio: '২০+ বছর ইসলামিক স্টাডিজ ও ফতোয়া বিভাগে অভিজ্ঞতা',
      qualification: 'এম.এ. ইন ইসলামিক স্টাডিজ, ইসলামী বিশ্ববিদ্যালয়',
      image: '/api/placeholder/150/150'
    },
    {
      name: 'ড. ফাতেমা বেগম',
      role: 'মহিলা মাসআলা বিশেষজ্ঞ',
      bio: 'মহিলাদের মাসআলা ও পরিবারিক বিষয়াদি বিশেষজ্ঞ',
      qualification: 'পিএইচডি ইন ইসলামিক জুরিসপ্রুডেন্স',
      image: '/api/placeholder/150/150'
    },
    {
      name: 'মাওলানা রফিকুল ইসলাম',
      role: 'কুরআন-হাদীস গবেষক',
      bio: 'কুরআন তাফসীর ও হাদীস বিশ্লেষণ বিশেষজ্ঞ',
      qualification: 'হাফিজুল কুরআন, এম.এ. ইন হাদীস সায়েন্স',
      image: '/api/placeholder/150/150'
    },
    {
      name: 'উস্তাদ সাবরিনা আক্তার',
      role: 'ইসলামিক শিক্ষা বিশেষজ্ঞ',
      bio: 'ইসলামিক শিক্ষা ও দাওয়াহ বিষয়ক বিশেষজ্ঞ',
      qualification: 'এম.এ. ইন ইসলামিক এডুকেশন',
      image: '/api/placeholder/150/150'
    }
  ];
